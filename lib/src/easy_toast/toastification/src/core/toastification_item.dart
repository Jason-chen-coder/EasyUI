...
typedef ToastificationBuilder =
    Widget Function(BuildContext context, ToastificationItem holder);
...
typedef ToastificationAnimationBuilder =
    Widget Function(
...
class ToastificationItem implements Equatable {
  ToastificationItem({
    ...
    if (autoCloseDuration != null) {
      _timer = PausableTimer(autoCloseDuration!, () {
  ...
  final ValueNotifier<ToastTimeStatus> _timeStatus = ValueNotifier(
    ToastTimeStatus.init,
  );
