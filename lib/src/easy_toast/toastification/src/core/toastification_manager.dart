...
import 'widget/toast_animated_list_view.dart';
...
class ToastificationManager {
  ToastificationManager({required this.alignment, required this.config});
  ...
  @visibleForTesting
  final listGlobalKey = GlobalKey<ToastAnimatedListState>();
  ...
  void dismiss(
    ...
    if (index != -1) {
      ...
      if (showRemoveAnimation) {
        listGlobalKey.currentState?.removeItem(index, (
      ...
      builder: (context) {
        Widget overlay = Align(
          ...
          child: Container(
            ...
            constraints: BoxConstraints(maxWidth: config.itemWidth),
            child: MediaQuery.removePadding(
              context: context,
              removeTop: true,
              removeBottom: true,
              child: ToastAnimatedList(
                key: listGlobalKey,
