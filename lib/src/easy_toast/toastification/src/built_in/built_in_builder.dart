...
import 'package:easy_ui/src/easy_toast/toastification/src/built_in/widget/common/on_hover_builder.dart';
...
class BuiltInBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor = ColorUtils.convertToMaterialColor(
      this.backgroundColor,
    );
...
class BuiltInToastBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final progressBarWidget =
        showProgressBar && item != null
...
class _BuiltInContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget toast = Padding(padding: margin, child: child);
  ...
  Widget build(BuildContext context) {
    return Listener(
      ...
      child: Dismissible(
        ...
        child: Opacity(opacity: 1 - currentOpacity, child: widget.child),
      ),
    );
  }
