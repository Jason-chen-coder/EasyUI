...
import 'package:easy_ui/src/easy_toast/toastification/src/utils/toast_theme_utils.dart';
import 'package:flutter/material.dart';

import '../../../../../../toastification.dart';
import '../../../../widget/common/close_button.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: IconTheme(
        data: Theme.of(
          context,
        ).primaryIconTheme.copyWith(color: toastStyle.iconColor),
        child: ConstrainedBox(
          constraints: toastStyle.constraints,
          child: Material(
            color: Colors.transparent,
            shape: LinearBorder.start(
              side: BorderSide(color: toastStyle.primaryColor, width: 3),
            ),
        ...
        children: [
          Offstage(
            ...
            child: Padding(
              ...
              child:
                  icon ??
                  Icon(toastStyle.icon, size: 24, color: toastStyle.iconColor),
            ),
          ),
          Expanded(
            child: ToastContent(
