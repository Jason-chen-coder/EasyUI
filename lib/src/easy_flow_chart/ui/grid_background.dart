...
class GridBackgroundParams extends ChangeNotifier {
  ...
  factory GridBackgroundParams.fromMap(Map<String, dynamic> map) {
    final params =
        GridBackgroundParams(
            gridSquare: map['gridSquare'].toDouble() as double? ?? 20.0,
          ...
          ..scale = map['scale'].toDouble() as double? ?? 1.0
          .._offset = Offset(
            map['offset.dx'].toDouble() as double? ?? 0.0,
            map['offset.dy'].toDouble() as double? ?? 0.0,
          );
