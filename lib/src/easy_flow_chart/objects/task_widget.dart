...
class TaskWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    double toolbarIconWrapperSize = 22;
    double toolbarIconSize = 15;
    ...
    bool isTriggerOrEnd = [
      TaskType.trigger,
      TaskType.end,
    ].contains(element.taskType);
    bool showEditIcon = isSelected && !isTriggerOrEnd;
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: SvgPicture.asset(
                      'assets/svgs/ic_actions_${TaskTypeExtension(element.taskType).toStringValue}.svg',
                      placeholderBuilder:
                  ...
                  Material(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: EdgeInsets.symmetric(
                            vertical: 8 * element.zoom,
                          ),
                          child: SvgPicture.asset('assets/svgs/ic_more.svg'),
                        ),
                      ),
                    ),
                  ),
