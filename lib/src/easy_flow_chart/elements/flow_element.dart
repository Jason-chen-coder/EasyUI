...
/// 组节点默认尺寸
const Size defaultGroupElementSize = Size(330, 80);
...
extension TaskTypeExtension on TaskType {
  String get toStringValue {
    switch (this) {
      ...
      case TaskType.wait:
        return "wait";
      case TaskType.centrifuge:
        return "centrifuge";
      case TaskType.seale:
        return "seale";
      case TaskType.deseale:
        return "deseale";
      case TaskType.load:
        return "load";
      case TaskType.pipetting:
        return "pipetting";
      case TaskType.aspirate:
        return "aspirate";
      case TaskType.dispense:
        return "dispense";
      case TaskType.pcr_recycle:
        return "pcr_recycle";
      case TaskType.mag:
        return "mag";
...
class FlowElement extends ChangeNotifier {
  ...
  factory FlowElement.fromMap(Map<String, dynamic> map) {
    final e =
        FlowElement(
            size: Size(
              map['size.width'].toDouble(),
              map['size.height'].toDouble(),
            ),
            ...
            rowsElementIds:
                (map['rowsElementIds'] as List<dynamic>?)
                    ?.map(
                      (row) =>
                          (row as List<dynamic>)
                              .map((id) => id.toString())
                ...
                [],
            colsElementIds:
                (map['colsElementIds'] as List<dynamic>?)
                    ?.map(
                      (col) =>
                          (col as List<dynamic>)
                              .map((id) => id.toString())
            ...
            stepParams: (map['stepParams'] as Map<String, dynamic>),
