import 'package:easy_ui/src/easy_flow_chart/ui/draw_group_column_plus.dart';
import 'package:easy_ui/src/easy_flow_chart/ui/element_widget.dart';
...
class EasyFlowChart extends StatefulWidget {
  ///
  const EasyFlowChart({
  ...
  @override
  State<EasyFlowChart> createState() => _EasyFlowChartState();
}

class _EasyFlowChartState extends State<EasyFlowChart> {
  bool scaling = false;
  @override
  void initState() {
    super.initState();
          ...
          children: [
            ...
            Positioned.fill(
              child: GestureDetector(
                ...
                onLongPress:
                    widget.onDashboardLongTapped == null
                        ? null
            ...
            for (int i = 0; i < widget.dashboard.elements.length; i++)
              ...
              ElementWidget(
                ...
                onElementLongPressed:
                    widget.onElementLongPressed == null
                        ? null
                ...
                onHandlerLongPressed:
                    widget.onHandlerLongPressed == null
                        ? null
                        : (context, position, handler, element) =>
