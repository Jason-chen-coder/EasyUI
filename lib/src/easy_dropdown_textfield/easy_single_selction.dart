...
class EasySingleSelection extends StatefulWidget {
  const EasySingleSelection({
    super.key,
  ...
  @override
  State<EasySingleSelection> createState() => _EasySingleSelectionState();
}

class _EasySingleSelectionState extends State<EasySingleSelection> {
