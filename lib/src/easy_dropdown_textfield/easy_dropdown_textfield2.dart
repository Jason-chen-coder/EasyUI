...
import 'easy_multi_selection2.dart';
import 'easy_single_selction.dart';

class EasyDropDownTextField2 extends StatefulWidget {
  const EasyDropDownTextField2({
    super.key,
    this.controller,
    this.initialValue,
  ...
  const EasyDropDownTextField2.multiSelection({
    super.key,
    this.controller,
  ...
  @override
  _DropDownTextFieldState2 createState() => _DropDownTextFieldState2();
}

class _DropDownTextFieldState2 extends State<EasyDropDownTextField2>
  ...
  updateFunction({EasyDropDownTextField2? oldWidget}) {
  ...
  @override
  void didUpdateWidget(covariant EasyDropDownTextField2 oldWidget) {
  ...
  Future<void> _showOverlay() async {
    ...
    _entry = OverlayEntry(
      builder:
          (context) => Positioned(
            width: size.width + widget.offsetWidth,
