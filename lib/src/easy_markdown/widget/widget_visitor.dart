...
class WidgetVisitor implements m.NodeVisitor {
  ...
  void visitText(m.Text text) {
    ...
    if (last is ElementNode) {
      final textNode =
          textGenerator?.call(text, config, this) ??
  ...
  final _tag2node = <String, SpanNodeGenerator>{
    MarkdownTag.h1.name:
        (e, config, visitor) => HeadingNode(config.h1, visitor),
    MarkdownTag.h2.name:
        (e, config, visitor) => HeadingNode(config.h2, visitor),
    MarkdownTag.h3.name:
        (e, config, visitor) => HeadingNode(config.h3, visitor),
    MarkdownTag.h4.name:
        (e, config, visitor) => HeadingNode(config.h4, visitor),
    MarkdownTag.h5.name:
        (e, config, visitor) => HeadingNode(config.h5, visitor),
    MarkdownTag.h6.name:
        (e, config, visitor) => HeadingNode(config.h6, visitor),
    ...
    MarkdownTag.ul.name:
        (e, config, visitor) =>
            UlOrOLNode(e.tag, e.attributes, config.li, visitor),
    MarkdownTag.blockquote.name:
        (e, config, visitor) => BlockquoteNode(config.blockquote, visitor),
    MarkdownTag.pre.name:
        (e, config, visitor) => CodeBlockNode(e, config.pre, visitor),
    ...
    MarkdownTag.input.name:
        (e, config, visitor) => InputNode(e.attributes, config),
    MarkdownTag.a.name:
        (e, config, visitor) => LinkNode(e.attributes, config.a),
    ...
    MarkdownTag.code.name:
        (e, config, visitor) => CodeNode(e.textContent, config.code),
    MarkdownTag.img.name:
        (e, config, visitor) => ImageNode(e.attributes, config, visitor),
  };
