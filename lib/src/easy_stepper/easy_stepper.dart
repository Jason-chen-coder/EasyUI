...
import 'core/base_step.dart';
import 'core/custom_scroll_behavior.dart';
import 'core/easy_line.dart';
import 'core/easy_step.dart';
import 'core/line_style.dart';
...
class EasyStepper extends StatefulWidget {
  ...
  const EasyStepper({
    ...
    this.lineStyle,
         ...
         maxReachedStep == null || reachedSteps == null,
...
class _EasyStepperState extends State<EasyStepper> {
  ...
  void initState() {
    ...
    if (widget.direction == Axis.horizontal) {
      ...
      if (!widget.disableScroll && widget.showScrollbar) {
        _padding = _padding.add(const EdgeInsetsDirectional.only(bottom: 0));
      }
    }
          ...
          child:
              widget.disableScroll
                  ? widget.direction == Axis.horizontal
                      ...
                      : Column(children: _buildEasySteps())
                  : ((kIsWeb ||
                          Platform.isWindows ||
                          Platform.isMacOS ||
                          Platform.isLinux) &&
  ...
  BaseStep _buildStep(int index) {
    ...
    return BaseStep(
      ...
      stepShape:
          index == widget.activeStep ? StepShape.rRectangle : widget.stepShape,
        ...
        ? Column(
          children: [
            Padding(
              ...
              child:
                  lineStyle.progress != null && index == widget.activeStep
            ...
            if (axis == Axis.horizontal &&
              ...
              SizedBox(
                ...
                child:
                    widget.steps[index].customLineWidget ??
                    Text(
