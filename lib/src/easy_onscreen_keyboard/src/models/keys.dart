...
sealed class EasyOnscreenKeyboardKey {
  /// Creates an [EasyOnscreenKeyboardKey].
  const EasyOnscreenKeyboardKey({
    this.flex = _flex,
    this.onTap,
    this.onTapDown,
    this.onTapUp,
  ...
  const factory EasyOnscreenKeyboardKey.text({
  ...
  const factory EasyOnscreenKeyboardKey.action({
...
class TextKey extends EasyOnscreenKeyboardKey {
  /// Creates a [TextKey].
  const TextKey._({
...
class ActionKey extends EasyOnscreenKeyboardKey {
