...
class EasyOnscreenKeyboardThemeData {
  /// Creates an instance of [EasyOnscreenKeyboardThemeData].
  const EasyOnscreenKeyboardThemeData({
    this.color,
    this.border,
    this.borderRadius,
    this.boxShadow,
  ...
  /// Copies the current [EasyOnscreenKeyboardThemeData] with the provided changes.
  EasyOnscreenKeyboardThemeData copyWith({
    Color? color,
    BoxBorder? border,
  ...
  /// Google Gboard theme.
  factory EasyOnscreenKeyboardThemeData.gBoard({Color? primary}) {
  ...
  /// iOS theme data.
  factory EasyOnscreenKeyboardThemeData.ios() {
    return EasyOnscreenKeyboardThemeData(
