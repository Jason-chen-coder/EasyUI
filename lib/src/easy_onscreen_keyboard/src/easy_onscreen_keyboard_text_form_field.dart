...
/// ### Usage
/// ```dart
/// const EasyOnscreenKeyboardTextFormField(
...
class EasyOnscreenKeyboardTextFormField extends StatefulWidget {
  /// Creates a new [EasyOnscreenKeyboardTextFormField] widget.
  const EasyOnscreenKeyboardTextFormField({
    super.key,
    this.formFieldKey,
  ...
  @override
  State<EasyOnscreenKeyboardTextFormField> createState() =>
      _OnscreenKeyboardTextFormFieldState();
}

class _OnscreenKeyboardTextFormFieldState
    extends State<EasyOnscreenKeyboardTextFormField>
