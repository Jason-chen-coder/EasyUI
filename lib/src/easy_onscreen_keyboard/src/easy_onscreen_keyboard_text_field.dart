...
class EasyOnscreenKeyboardTextField extends StatefulWidget {
  /// Creates a new [EasyOnscreenKeyboardTextField] widget.
  const EasyOnscreenKeyboardTextField({
    super.key,
  ...
  @override
  State<EasyOnscreenKeyboardTextField> createState() =>
      _OnscreenKeyboardTextFieldState();
}

/// State for [EasyOnscreenKeyboardTextField].
class _OnscreenKeyboardTextFieldState
    extends State<EasyOnscreenKeyboardTextField>
